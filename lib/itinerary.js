  ...
  },
  {
    ...
    blocks: [
      ...
      },
      {
        ...
        emoji: "🌙",
        title: "Back to Base",
        text: "Head back toward Gurgaon one more drink somewhere new from the saved list, or call it a night if today ran long.",
        items: [
  ...
  },
  {
    ...
    blocks: [
      ...
      },
      {
        ...
        text: "Lunch with Jayesh's mother nothing from the saved list quite fit a family lunch, so this one's an AI suggestion: an upscale-but-unhurried North Indian spot that works well for mixed ages.",
      ...
      },
      {
        ...
        text: "Private karaoke booths from the saved list, plus a cocktail bar nearby arcade/bowling venues in Gurgaon's malls are worth a live check since these change often, so we've kept this to what's actually confirmed.",
        items: [

...
export const AI = {
  ...
  dlfMallVasantKunj: { name: "DLF Mall (Vasant Kunj)", why: "The Vasant Kunj mall cluster (DLF Promenade/Emporio/Avenue) high-end shopping strip, good for a last morning of browsing.", bestTime: "Morning", duration: "1.5–2 hr", area: "Vasant Kunj, Delhi" },
};
...
export const DAYS = [
    ...
    blocks: [
      {
        ...
        items: [
          ...
          { kind: "place", id: "gurudwara-rakab-ganj" },
        ],
      },
      {
        key: "day",
      ...
      },
      {
        ...
        text: "Basant Lok Market for drinks, plus a swing over to Vasant Kunj for Gonzo and Myfroyoland the two sit close enough to Basant Lok/Vasant Vihar to fold into the same night. These lean casual by reputation and format (dive-bar/lounge style, no dress-code chatter found) rather than confirmed written policy door policies can change, so carrying valid ID is always a good idea regardless.",
        items: [
  ...
  },
  {
    ...
    blocks: [
      ...
      },
      {
        ...
        items: [{ kind: "ai", ...AI.majnuKaTilla }, { kind: "place", id: "chaina-ram-sindhi-halwai" }],
      },
      {
        key: "night",
        emoji: "🌙",
  ...
  },
  {
    ...
    date: "2026-07-19",
    label: "Sun, 19 July",
    heading: "Last-Morning Shopping, Then Home",
    blocks: [
      {
        key: "shopping",
        emoji: "🛍️",
        title: "DLF Mall Wander",
        text: "A shopping stop at the DLF mall cluster in Vasant Kunj before heading toward the airport it's on the way from South Delhi and only ~15–20 min further to Aerocity.",
        items: [{ kind: "ai", ...AI.dlfMallVasantKunj }],
      },
      {
        key: "morning",
        emoji: "🌤️",
    ...
    tips: {
      travel: "Vasant Kunj to Aerocity is ≈ 15–20 min. Aerocity to IGI Airport is a 5–10 min drive practically at the terminal.",
